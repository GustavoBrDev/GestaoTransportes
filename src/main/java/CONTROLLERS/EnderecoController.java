...
public class EnderecoController {
    ...
    @Operation (summary = "Cria um endereço", description = "Cria um endereço", tags = {"Endereços"} )
    ...
    @Tag( name = "Endereços", description = "Gerenciamento de endereços" )
    @Operation (summary = "Atualiza um endereço", description = "Atualiza um endereço", tags = {"Endereços"} )
    ...
    @Tag( name = "Endereços", description = "Gerenciamento de endereços" )
    @Operation (summary = "Busca um endereço", description = "Busca um endereço", tags = {"Endereços"} )
    ...
    @Tag( name = "Endereços", description = "Gerenciamento de endereços" )
    @Operation (summary = "Busca todos os endereços", description = "Busca todos os endereços", tags = {"Endereços"} )
    @ApiResponse(responseCode = "200", description = "Endereço encontrado com sucesso", content = @Content( schema = @Schema( implementation = EnderecoFullResponseDTO.class ),
            examples = @ExampleObject( value = "{\n" +
                    "    \"id\": 1,\n" +
                    "    \"rua\": \"Rua 1\",\n" +
    ...
    @Tag( name = "Endereços", description = "Gerenciamento de endereços" )
    @Operation (summary = "Deleta um endereço", description = "Deleta um endereço", tags = {"Endereços"} )
