...
public class RotaController {
    ...
    @PutMapping
    public ResponseEntity<RotaFullResponseDTO> atualizarRota ( @RequestBody @Valid RotaRequestDTO rotaRequestDTO, @RequestParam @Positive @NotNull Integer id) {
    ...
    @DeleteMapping
    public ResponseEntity<Void> deletarRota ( @RequestParam @Positive @NotNull Integer id) {
